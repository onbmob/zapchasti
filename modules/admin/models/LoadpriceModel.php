...
class LoadpriceModel extends ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'col_1' => '1 (A) колонку прайса => в укзанное поле БД',
            'col_2' => '2 (B) колонку прайса => в укзанное поле БД',
            'col_3' => '3 (C) колонку прайса => в укзанное поле БД',
            'col_4' => '4 (D) колонку прайса => в укзанное поле БД',
            'col_5' => '5 (E) колонку прайса => в укзанное поле БД',
            'col_6' => '6 (F) колонку прайса => в укзанное поле БД',
            'col_7' => '7 (G) колонку прайса => в укзанное поле БД',
            'col_8' => '8 (H) колонку прайса => в укзанное поле БД',
            'col_9' => '9 (I) колонку прайса => в укзанное поле БД',
            'col_10' => '10 (J) колонку прайса => в укзанное поле БД',
            'col_11' => '11 (K) колонку прайса => в укзанное поле БД',
            'col_12' => '12 (L) колонку прайса => в укзанное поле БД',
            'col_13' => '13 (M) колонку прайса => в укзанное поле БД',
            'col_14' => '14 (N) колонку прайса => в укзанное поле БД',
        ];
    }
